...
%
% Source: Overleaf, https://www.overleaf.com/latex/examples/matplotlib-and-random-cheat-sheet/yttxrcxntbht
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}{\huge{\textbf{Cheat Sheet Template}}}\\
...
\node [mybox] (box){%
    \begin{minipage}{0.3\textwidth}
		Here is a description and some text for Box 1: \\
        \\
		\textit{from random import *} \# and some code \\
        \\
        Here is another description and some more text for Box 2. Check out this neat Python interpreter:
        \\
        \textit{\$ python} \\
		\textit{>>> import random} \\
		\textit{>>> help(random)} \\
...
%------------ CAIXA PRELIMINARES ---------------------
\node[fancytitle, right=10pt] at (box.north west) {Box 2};
\end{tikzpicture}
...
%------------ DOIS EIXOS BOX ---------------------
\node[fancytitle, right=10pt] at (box.north west) {Box 4};
\end{tikzpicture}
...
\node[fancytitle, right=10pt] at (box.north west) {Box 5};
\end{tikzpicture}
...
%------------ PROPRIEDADES BOX ----------------
\node[fancytitle, right=10pt] at (box.north west) {Box 6};
\end{tikzpicture}
\end{multicols*}
\end{document}
